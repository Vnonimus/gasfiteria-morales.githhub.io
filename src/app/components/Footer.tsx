      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            <h2 className="text-white mb-4">Gasfitería Full Santiago</h2>
            <p className="text-gray-300 mb-4 max-w-md">
              Gasfitería profesional en Santiago. Instalador sanitario y autorizado SEC. 
              Servicios de calidad con garantía escrita.
            </p>
            <div className="flex items-center gap-2 text-yellow-400 bg-yellow-400/10 px-4 py-2 rounded-lg inline-flex">
              <ShieldCheck className="w-5 h-5" />
              <span>Gasfitería Autorizada SEC</span>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-2 text-gray-300">
                ...
                <span>Servicio a domicilio en Santiago y alrededores</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm text-center sm:text-left">
              © {currentYear} Gasfitería Full Santiago - César Morales. Todos los derechos reservados.
            </p>
            <p className="text-gray-400 text-sm text-center sm:text-right">
              Instalador Sanitario y Autorizado SEC
            </p>
          </div>
        </div>
      </div>
